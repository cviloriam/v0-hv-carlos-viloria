...
export function SkillsSection() {
  ...
  const iconMap = [Code2, FileText, Cloud, Database, Layers, GitBranch, Settings, Users]
  ...
  return (
    <section className="py-24 px-4 bg-muted/30">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="pt-8">
          <Card className="p-8">
            <h3 className="font-bold text-2xl mb-6 text-center">{t.skills.competenciesTitle}</h3>
